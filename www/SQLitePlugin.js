...
(function() {
  var IOS_REGEX, READ_ONLY_REGEX, SQLiteFactory, SQLitePlugin, SQLitePluginCallback, SQLitePluginTransaction, argsArray, nextTick, pcb, root, transactionsInProgress;
  ...
  SQLitePluginTransaction.prototype.start = function() {
    ...
    try {
       ...
       */
      transactionsInProgress[this.db.dbname] = false;
