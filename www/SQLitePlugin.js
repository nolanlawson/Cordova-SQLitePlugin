...
(function() {
  var READ_ONLY_REGEX, SQLiteFactory, SQLitePlugin, SQLitePluginCallback, SQLitePluginTransaction, nextTick, pcb, queryIdCounter, root, transactionIdCounter;
  ...
  SQLitePlugin = function(openargs, openSuccess, openError) {
    ...
    this.bg = typeof openargs.bgType !== 'undefined' ? openargs.bgType : true;
